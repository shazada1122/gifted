...
global.footer = "*ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝐅𝐀𝐌𝐎𝐔𝐒 𝐓𝐀𝐁𝐈𝐒𝐇*"; // Input Yours custom...(Maintain font for Flow)
 
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~uuISWCTB#ChE6uWU-vqdMx_vHC0gx3PShefGVohuHL0rh33dVJi8", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "923700338539", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "true",
AUTO_LIKE_STATUS: process.env.AUTO_LIKE_STATUS || "true",
AUTO_LIKE_EMOJI: process.env.AUTO_LIKE_EMOJI || "😎", //Input Yours custom...
AUTO_REPLY_STATUS: process.env.AUTO_REPLY_STATUS || "false",
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "💀👑🔥🔪🏴‍☠️   *Sedhi baat ka Ulta jwab dy kr samny waly ka pressure high krny ka talent hai mujh me* ......💀🔥🙌🏻.... 🪽❥︎ ᶠᵃᵐᵒᵘˢ ᵗᵃᵇⁱˢʰ ☠︎︎!", // // Input Yours custom...
MODE: process.env.MODE || "public", // Put private or public or inbox or groups
OWNER_NUMBER: process.env.OWNER_NUMBER || "923196335250", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "𝐅𝐀𝐌𝐎𝐔𝐒 𝐓𝐀𝐁𝐈𝐒𝐇", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "𝐅𝐀𝐌𝐎𝐔𝐒 𝐓𝐀𝐁𝐈𝐒𝐇", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "𝐅𝐀𝐌𝐎𝐔𝐒-𝐓𝐀𝐁𝐈𝐒𝐇💜", // Added // Input Yours custom...
...
BAD_WORDS: process.env.BAD_WORDS || "fuck, pussy, anus, idiot, L, Lun, Lul, Bc,", // Add Yours Separated by Comma(will be deleted if ANTIBAD is set to true)
ANTICALL_MSG: process.env.ANTICALL_MSG || "*_📞 Auto Call Reject Mode Activated by Gifted-Md. 📵 No Calls Allowed Dude!_*",
AUTO_REACT: process.env.AUTO_REACT || "false",
BOT_NAME: process.env.BOT_NAME || "𝐅𝐀𝐌𝐎𝐔𝐒-𝐓𝐀𝐁𝐈𝐒𝐇", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://qu.ax/cQZOL.jpg", // You can Replace with yours...
